...
classdef RAD_Model < handle
	properties
		...
		ptsrel = struct();
		% physical units of variables and parameters
		unit = struct();
		...
		opt = struct(  'heterogeneity_integration_order', 5 ...
			     ...
			     , 'time_integration', struct( 'scheme', 'trapezoidal' ...
			     				  ...
			     				  , 'adapt_step_for_stability', false ...
							  , 'abstol', 1e-4 ...
			                                  , 'reltol', 1e-3 ...
			     				  , 'dt_initial', 1 ...
		             				  , 'dt_min', 0 ...
			     ...
			     , 'compute_explicit_time_step_limit', false ...
			     , 'compute_swe_time_step_limit', false ...
		...
		hashfield_C  = {  'L' ...
				...
				, 'opt.time_integration.adapt_step_length' ...
				, 'opt.time_integration.dt_initial' ...
				, 'opt.time_integration.dt_min' ...
				, 'opt.time_integration.dt_event' ...
				, 'opt.time_integration.dt_max' ...
				, 'opt.time_integration.abstol' ...
				, 'opt.time_integration.reltol' ...
				, 'opt.nlsolver.name' ...
				, 'opt.nlsolver.abstol' ...
				, 'opt.nlsolver.maxiter' ...
				, 'opt.linear_solver.name' ...
				, 'opt.linear_solver.preconditioner' ...
				, 'opt.linear_solver.maxiter' ...
				, 'opt.linear_solver.tol' ...
